  ...
  return (
    <div className="relative admin-menu-container">
      <button
        ...
        className="p-2 sm:px-4 sm:py-2 border border-amber-500 dark:border-purple-600 text-amber-600 dark:text-purple-400 rounded-lg font-medium hover:bg-amber-500 dark:hover:bg-purple-600 hover:text-white transition duration-200 inline-flex items-center gap-2"
      >
