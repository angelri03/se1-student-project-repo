  ...
  return (
    <div className="relative admin-menu-container">
      <button
        ...
        className="p-2 sm:px-6 sm:py-3 border border-purple-600 text-purple-400 rounded-lg font-medium hover:bg-purple-600 hover:text-white transition duration-200 inline-flex items-center gap-2"
      >
