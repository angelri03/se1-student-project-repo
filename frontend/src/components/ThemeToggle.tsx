...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      type="button"
      className="p-2 sm:px-4 sm:py-2 rounded-lg transition-colors duration-200 bg-gray-200 hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 cursor-pointer"
