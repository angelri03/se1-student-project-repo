  ...
  return (
    <div className="relative">
      <button
        ...
        className="relative p-3 border border-gray-600 rounded-lg text-gray-300 hover:bg-gray-700 transition duration-200"
        title="Notifications"
      >
              ...
              notifications.map((notification) => (
                <div
                  ...
                  className={`p-4 border-b border-gray-700 hover:bg-gray-700 cursor-pointer transition ${
                    notification.is_read === 0 ? 'bg-gray-750' : ''
                  }`}
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className={`text-sm ${notification.is_read === 0 ? 'text-gray-100 font-medium' : 'text-gray-300'}`}>
