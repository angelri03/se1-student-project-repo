      ...
      <div className="max-w-6xl mx-auto">
        ...
        {projects.length === 0 ? (
          <div className="text-center py-12">
            ...
            <h2 className="text-2xl font-semibold text-gray-600 dark:text-gray-400 mb-2">No bookmarks yet</h2>
            <p className="text-gray-500 mb-6">Start exploring projects and bookmark your favorites!</p>
            <button
              onClick={() => navigate('/explore')}
              className="px-6 py-2 bg-amber-500 dark:bg-purple-600 text-white rounded-lg hover:bg-amber-600 dark:hover:bg-purple-700 transition duration-200"
            >
              Explore Projects
            </button>
          </div>
